export const pairs = [
  [" сп.", " BR"],
  ["Время в пути", "Travel times"],
  ["Что вы получите на консультации", "What your consultation includes"],
  [
    " — квартиры у парка и набережной Dubai Creek Harbour. Вид на залив, парк или город зависит от выбранного лота.",
    " — apartments beside the park and waterfront at Dubai Creek Harbour. Waterfront, park or city views depend on the selected unit.",
  ],
  ["Сроки и дополнительные расходы", "Dates and additional costs"],
  ["Развитие района", "Future neighbourhood development"],
  ["Время в пути и интерактивная карта", "Travel times"],
  ["Посмотреть интерактивную карту", "View the interactive map"],
  ["Площадь, этаж и варианты планировки", "Area, floor and layout options"],
  ["Новый проект · Emaar", "New launch · Emaar"],
  [
    " у парка и набережной. Балконы, панорамные окна и отдых у дома.",
    " beside the park and waterfront. Balconies, panoramic windows and leisure amenities at home.",
  ],
  ["Подробнее о проекте", "More about the project"],
  ["Видео проекта", "Project video"],
  ["Сравнить площади всех квартир", "Compare all apartment areas"],
